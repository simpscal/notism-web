...
const colorTokens = [
    ...
    { name: 'selected', var: '--selected', labelKey: 'selected' },
    { name: 'selected-foreground', var: '--selected-foreground', labelKey: 'selectedForeground' },
    { name: 'frame', var: '--frame', labelKey: 'frame' },
    { name: 'frame-foreground', var: '--frame-foreground', labelKey: 'frameForeground' },
