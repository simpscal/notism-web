...
describe('PaymentMethod', () => {
    it('renders Cash on Delivery option always', () => {
        renderWithProviders(<PaymentMethod value={PaymentMethodType.CashOnDelivery} onValueChange={() => {}} />);
    ...
    it('highlights Banking when selected', () => {
        renderWithProviders(<PaymentMethod value={PaymentMethodType.Banking} onValueChange={() => {}} />);
